...
#import "XZCameraViewController+UI.h"
...
@implementation XZCameraViewController (UI)
...
- (void)setupCameraView {
    ...
    [self refreshCameraViewWithRatio:[XZCameraManager shareManager].ratio];
